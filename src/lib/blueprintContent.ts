...
// Platform metadata (icon, color, name, description, category) lives in lib/platformCatalog.ts —
// shared with Landing.tsx and Integrations.tsx so the three don't drift out of sync.
