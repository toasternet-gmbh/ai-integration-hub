...
export const TOOL_INFO: Record<string, Bi> = {
  ...
  "contacts.update": { en: "Update a contact", de: "Kontakt aktualisieren" },
  "invoices.create": { en: "Create an invoice", de: "Rechnung erstellen" },
  "invoices.finalize": { en: "Finalize an invoice", de: "Rechnung finalisieren" },
  ...
  "products.categories.search": { en: "Search categories", de: "Kategorien durchsuchen" },
  "products.categories.get": { en: "Look up a category", de: "Kategorie abrufen" },
  "quotes.search": { en: "Search quotations", de: "Angebote durchsuchen" },
  "quotes.get": { en: "Look up a quotation", de: "Angebot abrufen" },
  "quotes.create": { en: "Create a quotation", de: "Angebot erstellen" },
  "order_confirmations.search": { en: "Search order confirmations", de: "Auftragsbestätigungen durchsuchen" },
  "order_confirmations.get": { en: "Look up an order confirmation", de: "Auftragsbestätigung abrufen" },
  "order_confirmations.create": { en: "Create an order confirmation", de: "Auftragsbestätigung erstellen" },
  "delivery_notes.search": { en: "Search delivery notes", de: "Lieferscheine durchsuchen" },
  "delivery_notes.get": { en: "Look up a delivery note", de: "Lieferschein abrufen" },
  "delivery_notes.create": { en: "Create a delivery note", de: "Lieferschein erstellen" },
...
export const PLATFORM_CATALOG: PlatformMeta[] = [
  {
    ...
    description: {
      en: "Order search, lookup, refunds, and cancellation, plus product (including creation), category, inventory, and customer tools.",
      de: "Bestellsuche, -abfrage, -erstattung und -stornierung sowie Produkt- (inkl. Erstellung), Kategorie-, Lager- und Kunden-Tools.",
    },
  ...
  },
  {
    ...
    description: {
      en: "Invoice, quotation, order confirmation, delivery note, and credit note search, lookup, creation, and editing, plus expense receipts, via Lexoffice's bookkeeping API.",
      de: "Rechnungs-, Angebots-, Auftragsbestätigungs-, Lieferschein- und Gutschriftsuche, -abfrage, -erstellung und -bearbeitung sowie Ausgabenbelege über die Buchhaltungs-API von Lexoffice.",
    },
    capabilities: [
  ...
  },
  {
    ...
    description: {
      en: "Invoice search, lookup, creation, finalization, payment recording, and cancellation, plus quotation, order confirmation, delivery note, and credit note search and lookup, and contact and product tools, via sevDesk's bookkeeping API.",
      de: "Rechnungssuche, -abfrage, -erstellung, -finalisierung, Zahlungserfassung und -stornierung sowie Angebots-, Auftragsbestätigungs-, Lieferschein- und Gutschriftsuche und -abfrage sowie Kontakt- und Produkt-Tools über die Buchhaltungs-API von sevDesk.",
    },
    capabilities: [
