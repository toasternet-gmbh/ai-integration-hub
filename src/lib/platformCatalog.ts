...
export const PLATFORM_CATALOG: PlatformMeta[] = [
  ...
  },
  {
    ...
    description: {
      en: "Invoice and contact search, lookup, creation, and editing, plus expense receipts, via Lexoffice's bookkeeping API.",
      de: "Rechnungs- und Kontaktsuche, -abfrage, -erstellung und -bearbeitung sowie Ausgabenbelege über die Buchhaltungs-API von Lexoffice.",
    },
    capabilities: [
