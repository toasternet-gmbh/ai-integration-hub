...
export const STRINGS: Record<string, { en: string; de: string }> = {
  ...
  "integrations.endpointOptional": { en: "Endpoint (optional)", de: "Endpunkt (optional)" },
  "integrations.homeserverUrl": { en: "Homeserver URL", de: "Homeserver-URL" },
  ...
  "integrations.connectOAuth": { en: "Connect", de: "Verbinden" },
  "integrations.oauthRedirectNotice": { en: "You'll be redirected to sign in and grant access — no credentials to enter here.", de: "Sie werden zur Anmeldung und Zugriffsfreigabe weitergeleitet — hier sind keine Zugangsdaten einzugeben." },
  "integrations.oauthCallbackPending": { en: "Finishing connection…", de: "Verbindung wird abgeschlossen…" },
  "integrations.oauthCallbackOk": { en: "Connected.", de: "Verbunden." },
  "integrations.oauthCallbackMissingParams": { en: "Missing parameters — the provider redirected without the expected code/state.", de: "Parameter fehlen — der Anbieter hat ohne den erwarteten Code/State weitergeleitet." },
  ...
  "landing.subhead": {
    en: "Connect your shop, your books, your website, and your team's time tracking — and let your AI assistant see and act on the real thing. Anything risky waits for your OK first.",
    de: "Verbinden Sie Ihren Shop, Ihre Buchhaltung, Ihre Website und die Zeiterfassung Ihres Teams — und lassen Sie Ihren KI-Assistenten mit echten Daten arbeiten. Alles Riskante wartet zuerst auf Ihre Freigabe.",
  },
  ...
  "landing.integratesWith": { en: "Integrates with", de: "Integriert mit" },
  "landing.cat.ecommerce": { en: "E-commerce", de: "E-Commerce" },
  "landing.cat.bookkeeping": { en: "Bookkeeping", de: "Buchhaltung" },
  "landing.cat.cms": { en: "CMS", de: "CMS" },
  "landing.cat.timeTracking": { en: "Time tracking", de: "Zeiterfassung" },
  "landing.cat.banking": { en: "Banking", de: "Banking" },
  "landing.cat.crm": { en: "CRM", de: "CRM" },
  "landing.cat.erp": { en: "ERP", de: "ERP" },
  "landing.cat.productivity": { en: "Productivity", de: "Produktivität" },
  "landing.cat.automation": { en: "Browser automation", de: "Browser-Automatisierung" },
  "landing.cat.messaging": { en: "Messaging", de: "Messaging" },
  "landing.signIn": { en: "Sign in", de: "Anmelden" },
  "landing.goToApp": { en: "Go to app", de: "Zur App" },
  "landing.hero.chatLabel": { en: "Your AI assistant", de: "Ihr KI-Assistent" },
  "landing.hero.youAsk": { en: "Refund order ORD-8821A — the customer says it never arrived.", de: "Bestellung ORD-8821A erstatten — die Kundin sagt, sie sei nie angekommen." },
  "landing.hero.assistantReplies": {
    en: "That's a real refund, so I need your OK first. Sending it to your Approvals inbox now.",
    de: "Das ist eine echte Rückerstattung, dafür brauche ich zuerst Ihre Freigabe. Ich sende sie jetzt an Ihr Freigabe-Postfach.",
  },
  "landing.hero.approvedNote": { en: "Approved — refund completed.", de: "Freigegeben — Rückerstattung abgeschlossen." },

  "landing.hero.youAsk2": { en: "Update the stock for SKU-992 to 50 units.", de: "Bestand für SKU-992 auf 50 Stück aktualisieren." },
  "landing.hero.assistantReplies2": { en: "Done. I've updated the stock for SKU-992 to 50 units in your store.", de: "Erledigt. Ich habe den Bestand für SKU-992 in Ihrem Shop auf 50 Stück aktualisiert." },

  "landing.hero.youAsk3": { en: "Did we receive the payment for Invoice #1024?", de: "Haben wir die Zahlung für Rechnung #1024 erhalten?" },
  "landing.hero.assistantReplies3": { en: "Yes, a payment of €450 was received via GoCardless today.", de: "Ja, eine Zahlung von 450 € ist heute über GoCardless eingegangen." },
  "landing.supportedPlatforms": { en: "Supported Platforms", de: "Unterstützte Plattformen" },
  "landing.platforms.title": { en: "Connect the tools you already use", de: "Verbinden Sie die Tools, die Sie bereits nutzen" },
  "landing.platforms.subtitle": {
    en: "Your shop, your books, your website, your team's time tracking, your bank — connect any of them below, and give your AI assistant one safe, approved way to work with all of them.",
    de: "Ihr Shop, Ihre Buchhaltung, Ihre Website, die Zeiterfassung Ihres Teams, Ihre Bank — verbinden Sie unten, was Sie brauchen, und geben Sie Ihrem KI-Assistenten einen sicheren, freigegebenen Weg, mit allem zu arbeiten.",
  },
  "landing.prop1.title": { en: "No coding required", de: "Keine Programmierung nötig" },
  "landing.prop1.body": {
    en: "Pick a platform, paste in your login details, and your AI assistant can start working with it in minutes.",
    de: "Plattform auswählen, Zugangsdaten eingeben — und Ihr KI-Assistent kann in wenigen Minuten damit arbeiten.",
  },
  "landing.prop2.title": { en: "You stay in control", de: "Sie behalten die Kontrolle" },
  "landing.prop2.body": {
    en: "Decide what your assistant can do on its own, and what always needs your OK first — refunds, price changes, anything risky.",
    de: "Sie legen fest, was Ihr Assistent allein darf und was immer Ihre Freigabe braucht — Rückerstattungen, Preisänderungen, alles Riskante.",
  },
  "landing.prop3.title": { en: "Nothing happens in the dark", de: "Nichts passiert im Verborgenen" },
  "landing.prop3.body": {
    en: "Every action your assistant takes is saved automatically, so you can always see exactly what happened and why.",
    de: "Jede Aktion Ihres Assistenten wird automatisch protokolliert — Sie sehen jederzeit genau, was passiert ist und warum.",
  },

  "landing.howItWorks.eyebrow": { en: "How it works", de: "So funktioniert es" },
  "landing.howItWorks.title": { en: "From zero to a safely-connected AI assistant.", de: "Von null zu einem sicher verbundenen KI-Assistenten." },
  ...
  "landing.howItWorks.step2.title": { en: "Name your assistant", de: "Ihrem Assistenten einen Namen geben" },
  "landing.howItWorks.step2.body": {
    en: "Give it an identity — like \"Claude\" or \"Nightly automation\" — so every action it takes can always be traced back to it.",
    de: "Geben Sie ihm eine Identität — z. B. „Claude“ oder „Nächtliche Automatisierung“ — damit sich jede Aktion stets zurückverfolgen lässt.",
  },
  "landing.howItWorks.step3.title": { en: "Decide what needs your OK", de: "Festlegen, was Ihre Freigabe braucht" },
  "landing.howItWorks.step3.body": {
    en: "Allow, deny, or require your approval for each action. We start you off with safe defaults.",
    de: "Erlauben, verweigern oder Ihre Freigabe verlangen — für jede Aktion. Wir starten mit sinnvollen, sicheren Standardwerten.",
  },
  "landing.howItWorks.step4.title": { en: "Let it work", de: "Loslegen lassen" },
  "landing.howItWorks.step4.body": {
    en: "Your assistant acts through the Hub. Anything risky pauses for your decision first; everything else is logged automatically.",
    de: "Ihr Assistent handelt über den Hub. Alles Riskante pausiert zuerst für Ihre Entscheidung; alles andere wird automatisch protokolliert.",
  },

  "landing.preview.eyebrow": { en: "See it in action", de: "In Aktion sehen" },
  "landing.preview.title": { en: "A real approval, waiting on you.", de: "Eine echte Freigabe, die auf Sie wartet." },
  "landing.preview.subtitle": {
    en: "This is what shows up the moment your AI assistant tries something that needs your OK — nothing happens until you decide.",
    de: "So sieht es aus, sobald Ihr KI-Assistent etwas versucht, das Ihre Freigabe braucht — nichts passiert, bevor Sie entscheiden.",
  },
