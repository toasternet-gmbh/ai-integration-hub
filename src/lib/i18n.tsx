...
export const STRINGS: Record<string, { en: string; de: string }> = {
  ...
  "superadmin.platforms.subtitle": { en: "The Hub-wide tool catalog every agent can be granted access to.", de: "Der Hub-weite Tool-Katalog, auf den jeder Agent Zugriff erhalten kann." },
